...
@section('content')
    ...
    <div id="preloader">
        ...
        <form action="{{ route('manage.manage_pullacc') }}" method="POST">
            @csrf
            <div class="row"> 
                <div class="col"></div>
                ...
                <div class="col-md-4">
                    ...
                    <button type="button" class="mb-2 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-warning" id="Save_opd">
                        <i class="fa-solid fa-1 me-2"></i>
                        {{-- <i class="fa-solid fa-arrow-up-right-from-square me-2"> </i> --}}
                        ดึงข้อมูล</button>    
                    <button type="button" class="mb-2 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-danger" id="Check_sit">
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, pull it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('manage.manage_pullaccsave') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, pull it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $("#spinner").show(); //Load button clicked show spinner 
                            $.ajax({
                                url: "{{ route('manage.manage_heck_sit') }}",
                                type: "POST",
                                dataType: 'json',
                                data: {
                                    datepicker,
