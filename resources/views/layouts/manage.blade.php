    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                {{-- class="logo-src" --}}
                <div><h4 style="color:rgb(225, 103, 255)" class="mt-2 ms-4">MAHATHEP</h4></div>
            ...
            <div class="app-header__mobile-menu">
                {{-- <div><h4 style="color:rgb(237, 199, 247, 0.781)" class="mt-4">MAHATHEP</h4></div> --}}
                <div>
            ...
            <div class="app-header__content">
                <div class="app-header-left">
                    ...
                    @endforeach --}}
                    {{-- <h4 style="color:rgb(237, 199, 247)" class="mt-2">Checksit Auto</h4> --}}
                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="mm-show">
                                    ...
                                    <li>
                                        <a href="{{ url('checksitauto') }}" target="_blank">
                                            <i class="metismenu-icon"></i>
                                             Checksit Auto 
                                        </a>
                                    </li>
